 ...
 * lists them, unabridged: a theme that omits one fails installation, which is
 * the guarantee that a site can switch to this theme without a single block
 * losing its rendering.
 *
