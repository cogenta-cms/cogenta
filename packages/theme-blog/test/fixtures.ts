...
export const BLOCKS: { readonly [T in VocabularyBlock['_type']]: BlockOfType<T> } = {
  hero: {
    ...
    subtitle:
      'A first draft tells you what a piece is about. The second is where you find out what it is for.',
    media: 'media-hero',
    actions: [{ label: 'Read the essay', target: { href: '/blog/what-the-second-draft-is-for' } }],
  },
  ...
  mediaFigure: {
    ...
    _version: VERSION,
    media: 'media-figure',
    caption: 'The notebook this essay grew out of',
    credit: 'Field Notes',
    ratio: '4:3',
    align: 'wide',
  },
    ...
    items: [
      {
        ...
        icon: 'book',
        title: 'Reading',
        text: 'Books reread and books abandoned.',
        link: { href: '/category/reading' },
      },
      { _key: 'f2', title: 'Writing', text: 'Drafts, revision and notebooks.' },
    ],
  },
  cta: {
    _key: 'b-cta',
    ...
    text: 'A short letter every other Sunday about what I have been reading.',
    actions: [
      { label: 'How to follow it', target: { href: '/newsletter' }, emphasis: 'primary' },
      { label: 'Read the latest letter', target: { href: '/blog/letter' } },
    ],
  },
  gallery: {
    _key: 'b-gallery',
  ...
  quote: {
    ...
    _type: 'quote',
    _version: VERSION,
    text: 'The greatest part of a writer’s time is spent in reading, in order to write.',
    author: 'Samuel Johnson',
    role: 'In Boswell’s Life of Johnson, 1775',
    avatar: 'media-avatar',
  },
  faq: {
    _key: 'b-faq',
  ...
  stats: {
    ...
    _type: 'stats',
    _version: VERSION,
    title: 'Fourteen years, counted',
    items: [
      { _key: 's1', value: '312', unit: 'hours', label: 'Read on the 7:52' },
      { _key: 's2', value: '40', label: 'Notebooks filled' },
    ],
  },
  logos: {
    _key: 'b-logos',
  ...
  testimonial: {
    ...
    attribution: { name: 'Mara Lindqvist', role: 'Reader in Gothenburg', avatar: 'media-avatar' },
  },
  pricingTable: {
    _key: 'b-pricing',
    _type: 'pricingTable',
    _version: VERSION,
    title: 'Support the writing',
    tiers: [
      {
        _key: 'p1',
        name: 'Reader',
  ...
  statCounter: {
    ...
    title: 'Since 2011',
    stats: [
      { _key: 'c1', value: '1,240', label: 'Pages of drafts' },
      { _key: 'c2', value: '45', label: 'Books read on the train' },
    ],
  },
  logoStrip: {
    _key: 'b-logo-strip',
