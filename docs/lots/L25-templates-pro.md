...
| Phase 1 vague 2 — entreprise, magazine, portfolio, ecommerce (passes pro) | en cours | par paires pour limiter le risque de limite de session : entreprise + ecommerce lancés 2026-09-05 ~15:30, puis magazine + portfolio ; règle D5 dans le brief |
