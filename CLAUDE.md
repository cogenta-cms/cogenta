...
| Élément | Valeur |
|---|---|
| Lot en cours | **L2 — Admin** (`docs/lots/L2-admin.md`) — tâches 1-4 faites (coquille, mot de passe, TOTP libre-service + passkeys, `GET /api/schema` et liste de collections filtrée par permission) ; reste pour la tâche 3 : UI d'inscription de passkey (page réglages pas encore construite) ; tâche 5 (composants de champ) à faire ensuite |
| Lots terminés | L0 (socle), L1 (contenu), L3 (rendu). 1769 tests unitaires, tous verts. |
