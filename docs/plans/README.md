...
| 73 | [Thèmes en dossier local, bac à sable isolé, génération par IA](73-themes-locaux-bac-a-sable-ia.md) | — (fondation pour tout thème généré par IA) | **terminée** (8/8 tâches + câblage HTTP) — reste : écran admin, insertion d'ADR-0034 |
