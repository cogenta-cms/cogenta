...
## 16. Fiche 16 — Formulaires : Postgres/MySQL/MariaDB non exécutés, une demande refusée
...
prouve. Le `security-reviewer` complet (multi-phase, sur tout le diff) n'a pas été lancé
cette session — la revue ci-dessus a été faite manuellement, ciblée sur les fichiers
propres à cette fiche, faute de budget pour la version automatisée complète.
