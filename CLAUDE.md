...
| Élément | Valeur |
|---|---|
| Lot en cours | **L2 — Admin** (`docs/lots/L2-admin.md`) — tâches 1-5 faites (coquille, auth complète, `GET /api/schema`, liste filtrée par permission, un composant par type de champ) ; reste pour la tâche 3 : UI d'inscription de passkey (page réglages pas encore construite) ; tâche 6 (liste de collection : filtres, tri, pagination) à faire ensuite |
| Lots terminés | L0 (socle), L1 (contenu), L3 (rendu). 1782 tests unitaires, tous verts. |
