...
> **Acté (ADR-0026, amendée par ADR-0030), non figé.** Ce contrat repose sur
> l'**ADR-0026**, actée dans `docs/03-decisions.md` ; son renoncement initial sur le champ
> `file` et les champs conditionnels est levé par l'**ADR-0030**. La fiche 16 est son
> premier consommateur, la fiche 47 le second.
...
renoncement de l'ADR-0026, actée en **ADR-0030**). Un champ `file` restreint sa catégorie
acceptée
...
`forms@1.1` (ADR-0026 amendée par ADR-0030, non figé) — passé de `1.0` par la fiche 47 :
