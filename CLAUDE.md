...
| Ordre des lots | `L0 → L1 → L3 → L2 → L4 → L5 → L9(installeur) → L6 → L7 → L8` — **tous faits**, plus aucun lot planifié en attente. |
