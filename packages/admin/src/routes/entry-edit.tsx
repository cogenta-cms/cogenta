...
export function EntryEditRoute(): JSX.Element {
  ...
  return (
    <section aria-labelledby="entry-heading">
      ...
      {/* Views over the last 30 days, trend, and rank on the site (fiche 27
          task 2) — the audience of this article, visible while updating it.
          Renders nothing at all until a stats fetch actually resolves: a
          silent card for "not applicable" is quieter than a false zero. */}
