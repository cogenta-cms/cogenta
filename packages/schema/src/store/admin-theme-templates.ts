...
const NIGHTOPS: AdminThemeTemplate = {
  ...
  name: 'Nightops',
  description:
    'A near-black console with one vivid signal-green accent. Space Grotesk throughout, JetBrains Mono for technical details.',
  light: {
    background: '#fafafa',
    foreground: '#0e1013',
    card: '#ffffff',
    cardForeground: '#0e1013',
    muted: '#f1f2f4',
    mutedForeground: '#63676f',
    border: '#e3e5e9',
    input: '#d3d6db',
    ring: 'oklch(0.56 0.17 145)',
    primary: 'oklch(0.56 0.17 145)',
    primaryForeground: '#f6fef9',
    secondary: '#f5f6f7',
    secondaryForeground: '#0e1013',
    accent: 'oklch(0.56 0.17 145 / 10%)',
    accentForeground: 'oklch(0.4 0.15 145)',
    destructive: 'oklch(0.55 0.22 25)',
    destructiveForeground: '#fff6f5',
    destructiveSurface: 'oklch(0.55 0.22 25 / 10%)',
    success: 'oklch(0.56 0.17 145)',
    successForeground: '#f6fef9',
    successSurface: 'oklch(0.56 0.17 145 / 10%)',
    warning: 'oklch(0.62 0.16 60)',
    warningForeground: '#211703',
    warningSurface: 'oklch(0.62 0.16 60 / 14%)',
    info: 'oklch(0.55 0.16 240)',
    infoForeground: '#f5f9ff',
    infoSurface: 'oklch(0.55 0.16 240 / 10%)',
    shadowCard: '0 1px 2px rgb(14 16 19 / 0.04), 0 1px 3px rgb(14 16 19 / 0.06)',
    shadowRaised: '0 4px 8px -2px rgb(14 16 19 / 0.08), 0 12px 24px -8px rgb(14 16 19 / 0.1)',
    shadowOverlay: '0 8px 16px -4px rgb(14 16 19 / 0.12), 0 32px 64px -16px rgb(14 16 19 / 0.18)',
  },
  dark: {
    background: '#0a0b0d',
    foreground: 'oklch(0.92 0.006 100)',
    card: '#131519',
    cardForeground: 'oklch(0.92 0.006 100)',
    muted: '#16181d',
    mutedForeground: 'oklch(0.68 0.006 100)',
    border: 'oklch(1 0 0 / 8%)',
    input: 'oklch(1 0 0 / 14%)',
    ring: 'oklch(0.82 0.2 130)',
    primary: 'oklch(0.82 0.2 130)',
    primaryForeground: '#08090b',
    secondary: '#16181d',
    secondaryForeground: 'oklch(0.92 0.006 100)',
    accent: 'oklch(0.82 0.2 130 / 14%)',
    accentForeground: 'oklch(0.82 0.2 130)',
    destructive: 'oklch(0.68 0.19 25)',
    destructiveForeground: '#1c0704',
    destructiveSurface: 'oklch(0.68 0.19 25 / 14%)',
    success: 'oklch(0.82 0.2 130)',
    successForeground: '#08090b',
    successSurface: 'oklch(0.82 0.2 130 / 14%)',
    warning: 'oklch(0.78 0.15 70)',
    warningForeground: '#1f1503',
    warningSurface: 'oklch(0.78 0.15 70 / 14%)',
    info: 'oklch(0.75 0.13 240)',
    infoForeground: '#071420',
    infoSurface: 'oklch(0.75 0.13 240 / 14%)',
    shadowCard: '0 1px 0 rgb(0 0 0 / 0.4), 0 4px 12px -2px rgb(0 0 0 / 0.4)',
    shadowRaised: '0 2px 0 rgb(0 0 0 / 0.45), 0 16px 32px -8px rgb(0 0 0 / 0.5)',
    shadowOverlay: '0 4px 0 rgb(0 0 0 / 0.5), 0 40px 80px -16px rgb(0 0 0 / 0.65)',
  },
