...
export const THEME_STRINGS: Readonly<Record<ThemeLocale, ThemeStrings>> = {
  en: {
    ...
    'comments.closed': 'Comments are closed on this page.',
    'comments.name': 'Name',
    'comments.email': 'Email (not published)',
    'comments.website': 'Website (optional)',
    'comments.body': 'Comment',
    'comments.replyBody': 'Reply',
    'comments.submit': 'Post comment',
    'comments.submitReply': 'Post reply',
    'comments.notice.approved': 'Thank you, your comment is published.',
    'comments.notice.pending': 'Thank you, your comment will appear once it has been reviewed.',
    'comments.notice.invalid':
      'Your comment could not be sent: check your name, email address and message.',
    'comments.notice.rateLimited':
      'Too many comments in a short time: please try again in a few minutes.',
    'comments.notice.closed': 'Comments are closed on this page.',
  ...
  fr: {
    ...
    'comments.closed': 'Les commentaires sont fermés sur cette page.',
    'comments.name': 'Nom',
    'comments.email': 'Adresse e-mail (non publiée)',
    'comments.website': 'Site web (facultatif)',
    'comments.body': 'Commentaire',
    'comments.replyBody': 'Réponse',
    'comments.submit': 'Publier le commentaire',
    'comments.submitReply': 'Publier la réponse',
    'comments.notice.approved': 'Merci, votre commentaire est publié.',
    'comments.notice.pending': 'Merci, votre commentaire sera publié après relecture.',
    'comments.notice.invalid':
      'Votre commentaire n’a pas pu être envoyé : vérifiez le nom, l’adresse e-mail et le message.',
    'comments.notice.rateLimited':
      'Trop de commentaires envoyés à la suite : réessayez dans quelques minutes.',
    'comments.notice.closed': 'Les commentaires sont fermés sur cette page.',
    'comments.notice.error': 'Votre commentaire n’a pas pu être envoyé. Réessayez dans un instant.',
    'form.honeypot': 'Laissez ce champ vide',
