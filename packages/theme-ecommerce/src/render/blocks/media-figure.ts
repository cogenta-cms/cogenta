 ...
 *
 * - `start` / `end`: the brand-story split. The photograph takes seven
 *   columns on its side and the caption, set at the lead size, takes the
 *   other four, so a short caption reads as the story beside the picture.
    ...
    block.caption === undefined && block.credit === undefined
      ...
      : h(
          ...
          block.caption === undefined
            ? null
            : h('span', { class: 'ce-figure__text', 'data-field': 'caption' }, block.caption),
