...
export function AssistantPanel({
  ...
  if (available !== true || tools === null || tools.length === 0) return null
  ...
  return (
    <Card aria-labelledby="assistant-panel-title">
      ...
      <CardBody className="flex flex-col gap-4">
        ...
        {tools.some((tool) => tool.tool === 'assist.rewrite') && (
          <div className="flex flex-col gap-1">
        ...
        {tools.some((tool) => tool.needs.includes('targetLocale')) && siteLocales.length > 1 && (
          <div className="flex flex-col gap-1">
