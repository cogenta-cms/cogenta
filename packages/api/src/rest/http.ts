...
const STATUS_BY_CODE: Partial<Record<ErrorCode, number>> = {
  ...
  // equivalent codes just above (`TAXONOMY_TERM_HAS_CHILDREN`/`TAXONOMY_CYCLE`).
  MEDIA_FOLDER_NOT_FOUND: 404,
  MEDIA_FOLDER_INVALID: 400,
  MEDIA_FOLDER_NAME_TAKEN: 409,
  MEDIA_FOLDER_NOT_EMPTY: 409,
  MEDIA_FOLDER_CYCLE: 400,
  MEDIA_FOLDER_TOO_DEEP: 400,
  ...
  // Fiche feedback — a polled progress job id that was never issued, or one
  // already swept a few minutes after finishing. Same shape as
  // `SCHEDULER_QUEUE_JOB_NOT_FOUND`.
  AGENT_RUN_JOB_UNKNOWN: 404,
